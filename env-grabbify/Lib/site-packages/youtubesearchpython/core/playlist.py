...
class PlaylistCore(RequestCore):
    ...
    def __getComponents(self) -> None:
        inforenderer = self.responseSource["sidebar"]["playlistSidebarRenderer"]["items"][0][
            "playlistSidebarPrimaryInfoRenderer"]
        channelrenderer = \
            self.responseSource["sidebar"]["playlistSidebarRenderer"]["items"][1][
                "playlistSidebarSecondaryInfoRenderer"][
                "videoOwner"]["videoOwnerRenderer"]
        videorenderer = \
            self.responseSource["contents"]["twoColumnBrowseResultsRenderer"]["tabs"][0]["tabRenderer"]["content"][
        ...
        playlistElement = {
            'info': {
                ...
                "channel": {
                    "id": self.__getValue(channelrenderer,
