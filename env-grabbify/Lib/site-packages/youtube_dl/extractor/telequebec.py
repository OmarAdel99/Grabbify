...
class TeleQuebecBaseIE(InfoExtractor):
    ...
    def _brightcove_result(brightcove_id, player_id, account_id='6150020952001'):
        return {
            ...
            'url': smuggle_url(TeleQuebecBaseIE.BRIGHTCOVE_URL_TEMPLATE % (account_id, player_id, brightcove_id),
                               {'geo_countries': ['CA']}),
...
class TeleQuebecIE(TeleQuebecBaseIE):
    ...
    def _real_extract(self, url):
        ...
        media = self._download_json(
            ...
            media_id)['media']
        source_id = next(source_info['sourceId'] for source_info in media['streamInfos'] if
                         source_info.get('source') == 'Brightcove')
