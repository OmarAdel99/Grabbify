...
class VideomoreIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        partner_id = mobj.group('partner_id') or \
                     compat_parse_qs(compat_urllib_parse_urlparse(url).query).get('partner_id', [None])[0] or '97'
        ...
        if not formats:
            ...
            if error:
                if error in ('Данное видео недоступно для просмотра на территории этой страны',
