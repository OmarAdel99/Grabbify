...
class FranceCultureIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        title = video_data.get('data-asset-title') or video_data.get('data-diffusion-title') or self._og_search_title(
            webpage)
        ...
        return {
            ...
            'uploader': uploader,
            'timestamp': int_or_none(video_data.get('data-start-time')) or int_or_none(
